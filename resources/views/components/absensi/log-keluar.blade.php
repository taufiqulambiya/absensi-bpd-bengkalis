...
<div class="card-body" id="record-out">
    <div class="text-center p-3 no-data">
        ...
        <button class="btn btn-primary d-block mx-auto mb-3 show-record" @if ($disableLog) disabled @endif>Log
            Absen Keluar</button>
    </div>
        ...
        <ul class="list-group mb-3">
            ...
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h5 class="text-right">{{ $jamKerja->formatted ?? '-' }}</h5>
                    </div>
                </div>
            </li>
            <li class="list-group-item">
