    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-success btn-acc" data-id="{{ $item->id }}" data-status="accepted_kabid"
                    title="Setujui">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-success btn-acc" data-id="{{ $item->id }}" data-status="accepted_admin"
                    title="Setujui">
                    <span class="fas fa-check"></span>
                </button>
                <button class="btn btn-danger btn-reject" data-id="{{ $item->id }}" title="Tolak">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-success btn-acc" data-id="{{ $item->id }}" data-status="accepted_pimpinan"
                    title="Setujui">
                    <span class="fas fa-check"></span>
                </button>
                <button class="btn btn-danger btn-reject" data-id="{{ $item->id }}" title="Tolak">
