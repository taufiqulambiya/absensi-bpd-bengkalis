                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="row">
                                    <div class="col-12">
                                        <button class="btn btn-primary" disabled onclick="showErrorAlert('Hanya Admin yang dapat melakukan tindakan ini.')"><i
                                        ...
                                        <table id="datatable" class="table datatable table-striped table-bordered"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-info" disabled onclick="showErrorAlert('Hanya Admin yang dapat melakukan tindakan ini.')">
                                                            <span class="fas fa-pencil"></span>
                                                        </button>
                                                        <button class="btn btn-danger" disabled title="Hapus">
